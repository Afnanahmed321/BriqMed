    ...
    <header className="fixed inset-x-0 top-0 z-50">
      ...
      >
        <nav
          ...
          className={`relative mx-auto flex items-center justify-between transition-all duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] ${
            isScrolled
            ...
            {navItems.map((item) => {
              ...
              return (
                <Link
                  key={item.name}
                  href={item.href}
                  className={`relative px-6 py-2.5 text-[15px] font-medium tracking-wide transition-all duration-300 rounded-full outline-none ring-offset-1 ring-blue-600 focus-visible:ring-2 ${
                    isActive
        ...
        <div
          className={`grid transition-all duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] lg:hidden ${
        ...
        >
          <div className="overflow-hidden">
            <div className="rounded-3xl border border-slate-200/80 bg-white/95 p-6 shadow-[0_20px_50px_rgba(0,0,0,0.08)] backdrop-blur-2xl">
                ...
                {navItems.map((item) => {
                  ...
                  return (
                    <Link
                      ...
                      className={`flex items-center justify-between rounded-2xl px-5 py-3.5 text-base font-medium transition-all duration-200 ${
                        isActive
              ...
              <div className="mt-5 pt-5 border-t border-slate-100">
                <a
                  href="tel:+16463416783"
                  onClick={() => setIsMenuOpen(false)}
                  className="flex w-full items-center justify-center gap-3 rounded-2xl bg-blue-600 py-3.5 text-base font-semibold text-white shadow-md shadow-blue-600/20 transition-all duration-300 hover:bg-blue-700 active:scale-[0.98]"
                >
                  <Phone size={18} strokeWidth={2.2} className="animate-bounce" />
